...
namespace GlobalMindzDataAccess
{
    ...
    public partial class ADMN_MST_UserSettingKeys
    {
        public int UserSettingKeyID { get; set; }
        public string UserSettingKeyName { get; set; }
        public string UserSettingKeyDescription { get; set; }
